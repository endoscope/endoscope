...
public interface SearchableStatsStorage {
     ...
     * Otherwise children property should be null.
     *
     * For simplicity it might include children of root stats - they should be ignored during serialization.
     * @param from required
     * @param to required
     * @param to appInstance
     * @param to appType
     * @return
     */
    Stats topLevel(Date from, Date to, String appInstance, String appType);
     ...
     * @return
     */
    StatDetails stat(String id, Date from, Date to, String appInstance, String appType);
