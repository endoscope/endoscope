...
public class AggregatedJdbcStorageTest {
    ...
    @Before
    public void setup(){
        storage = new AggregatedJdbcStorage(defaultStorage, dailyStorage, weeklyStorage, monthlyStorage);
    }
    ...
    public void shouldUpdateExistingAggregateForDailyStats(){
        ...
        assertEquals(parse("2000-03-03 00:00:05"), statsCaptor.getValue().getStartDate());
        assertEquals(parse("2000-03-03 23:59:50"), statsCaptor.getValue().getEndDate());
    ...
    public void shouldUpdateExistingAggregateForWeeklyStats(){
        ...
        assertEquals(parse("2016-10-17 00:00:05"), statsCaptor.getValue().getStartDate());
        assertEquals(parse("2016-10-23 23:59:50"), statsCaptor.getValue().getEndDate());
        assertEquals(8, statsCaptor.getValue().getLost());
        assertTrue(statsCaptor.getValue().getMap().containsKey("x"));
        assertTrue(statsCaptor.getValue().getMap().containsKey("y"));
    }
    ...
    public void shouldUpdateExistingAggregateForMonthlyStats(){
        ...
        assertEquals(parse("2016-10-01 00:00:05"), statsCaptor.getValue().getStartDate());
        assertEquals(parse("2016-10-31 23:59:50"), statsCaptor.getValue().getEndDate());
        assertEquals(8, statsCaptor.getValue().getLost());
        assertTrue(statsCaptor.getValue().getMap().containsKey("x"));
        assertTrue(statsCaptor.getValue().getMap().containsKey("y"));
    }
